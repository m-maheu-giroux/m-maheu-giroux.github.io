...
<div class = "column right">
### <i class = "glyphicon glyphicon-user"> </i> Dr. Gideon Kye-Duodu
Visiting Researcher (FRQS PBEEE Scholar) from the Binka School of Public Health, University of Health and Allied Sciences (Ho, Ghana). Research Topic: *Early infant diagnosis of HIV in Ghana*. 
</div>
</div>
...
<div class = "row">
<div class = "column left">
<img src = "Yixin_Zhang.jpg" align = "left" width = "100" height = "100"  />
</div>
<div class = "column right">
### <i class = "glyphicon glyphicon-user"> </i> Yixin (Claire) Zhang
Yiqin is completing her BSc in Mathematics & Computer Sciences at McGill. She is a 2025 awardee of a *McGill Center for Viral Diseases* (MCVD) *Undergraduate Research Fellowship*.
</div>
</div>
